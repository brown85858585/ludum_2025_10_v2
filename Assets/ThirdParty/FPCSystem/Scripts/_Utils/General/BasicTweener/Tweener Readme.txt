#Unity Simple Tweener Simple Tweener for Unity3D referenced by ITween(https://www.assetstore.unity3d.com/kr/#!/content/84)
...
gameObject.AddTween(new TweenMove(xpos,ypos,zpos,delay, easetype).Next(
      				new TweenScale(xScale,yScale,zScale,delay,easetype).EndEvent(()=> { //To Do })) );
