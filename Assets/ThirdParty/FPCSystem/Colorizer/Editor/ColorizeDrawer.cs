...
public class ColorizeDrawer : PropertyDrawer
{
    ...
    ColorizeAttribute colorizeAttribute { get { return (ColorizeAttribute)attribute; } }
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
		...
		labelStyle.normal.textColor = AssignColor(colorizeAttribute.color);
		...
		switch(property.propertyType)
		{
	       ...
	       case SerializedPropertyType.Vector2:
	       {
				...
				Vector2 vector2Value = EditorGUI.Vector2Field(position, " ", property.vector2Value);
	       ...
	       case SerializedPropertyType.Vector3:
	       {
				EditorGUI.LabelField(position,new GUIContent(label), labelStyle);
	            EditorGUI.BeginChangeCheck();
	            Vector3 vector3Value = EditorGUI.Vector3Field(position, " ", property.vector3Value);
	            if (EditorGUI.EndChangeCheck())
